...
interface Props {
  ...
  /** Allow Honeystream Remote extension to inject player scripts. */
...
export class Webview extends Component<Props, State> {
  ...
  private onMessage(event: MessageEvent) {
    ...
    if (data.type === `honeystream-webview-init${this.id}`) {
    ...
    if (data.type === 'honeystream-webview-event') {
  ...
  render() {
    ...
    // TODO: Update React and types so these props can be passed in
