...
const defaultUserAgent =
  'Mozilla/5.0 (compatible; Mediabot/1.0; Googlebot; +https://gethoneystream.com/)'
...
export const HOME_WEBSITE = 'https://gethoneystream.com'
export const APP_WEBSITE = 'https://app.gethoneystream.com'
