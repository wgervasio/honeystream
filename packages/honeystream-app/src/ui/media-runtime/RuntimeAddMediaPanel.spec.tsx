...
describe('RuntimeAddMediaPanel', () => {
  it('renders URL add controls without local-file controls by default', () => {
    ...
    expect(html).toContain('clean zero-retry lanes before faster repaired lanes')
  ...
  it('selects source lanes without queueing fake URLs', () => {
    ...
    try {
      ...
      expect(container.textContent).toContain('clean lanes winning before recovered retries')
