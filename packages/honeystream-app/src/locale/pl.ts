export default {
  ...
  enterJoinDest: 'Wpisz link sesji Honeystream.',
  findSession: 'Znajdź sesje',
  findSessionDescription:
    'Dołącz do <1>#sessions</1> kanału społeczności Honeystream na Discordzie, aby znależć sesje innych użytkowników. Kliknij w logo poniższe logo Discorda, +aby dołączyć.',
  ...
  networkDisconnectMultiTab:
    'Jesteś hostem sesji Honeystream w więcej niż jednej karcie przeglądarki. Proszę zamknij inne karty lub przeglądarki, następnie odśwież stronę.',
  ...
  updateAvailable:
    'Jest dostępna aktualizacja Honeystream. Kliknij UPDATE w prawym górnym rogu, aby zaktualizować',
