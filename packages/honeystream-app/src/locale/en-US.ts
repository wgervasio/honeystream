export default {
  ...
  findSessionDescription:
    'Join the <1>#sessions</1> channel on the Honeystream Discord community to find other users’ sessions. Click the Discord logo below to join.',
  ...
  networkDisconnectMultiTab:
    'You are hosting a Honeystream session from more than one browser or tab. Please close the other tabs or other browsers, then reload the page.',
  ...
  updateAvailable:
    'An update for Honeystream is available. Press the UPDATE button in the top-right to receive the update.',
  username: 'Username',
  users: 'Users',
