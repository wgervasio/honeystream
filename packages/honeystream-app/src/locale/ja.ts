export default {
  ...
  enterJoinDest: 'HoneystreamのセッションのURLを入力してください。',
  findSession: 'セッションを探す',
  findSessionDescription:
    'Discordのコミュニティ「Honeystream」の<1>#sessions</1>チャンネルで他の人のセッションを見つけることができます。 以下のロゴマークをクリックしてDiscordコミュニティ参加できます。',
  ...
  networkDisconnectMultiTab:
    'あなたは複数のブラウザまたはタブでHoneystreamのセッションをホストしています。 他のブラウザまたはタブを閉じてから、ページを再読み込みしてください。',
  ...
  updateAvailable:
    '新しいHoneystreamのアップデートがあります。右上のUPDATEボタンを押すとアップデートが始まります。',
  username: 'ユーザー名',
  users: 'ユーザー',
  ...
  welcome: 'ようこそ',
  welcomeToHoneystream: 'Honeystreamへようこそ',
  welcomeMessage1: 'Honeystreamをお試しいただきありがとうございます！'
}
