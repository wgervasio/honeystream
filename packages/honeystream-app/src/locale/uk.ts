export default {
  ...
  duplicate: 'Дублювати',
  embedBlocked:
    'Щоб увімкнути відтворення за допомогою <1>{host}}</1>, Honeystream має відкрити веб-сайт у спливаючому меню.',
  ...
  enterJoinDest: 'Введіть посилання на сеанс Honeystream.',
  findSession: 'Знайти сеанс',
  findSessionDescription:
    'Приєднуйтесь до каналу <1>#sessions</1> в спільноті Honeystream Discord, щоб знайти сеанси інших користувачів. Натисніть логотип Discord нижче, щоб приєднатися.',
  ...
  networkDisconnectMultiTab:
    'Ви розміщуєте сеанс Honeystream з більш ніж одного браузера або вкладки. Закрийте інші вкладки або інші браузери, а потім перезавантажте сторінку.',
  ...
  updateAvailable:
    'Доступне оновлення Honeystream. Натисніть кнопку UPDATE у верхньому правому куті, щоб отримати оновлення.',
  ...
  welcomeToHoneystream: 'Ласкаво просимо до Honeystream',
  welcomeMessage1: 'Привіт, дякуємо за спробу Honeystream!'
}
