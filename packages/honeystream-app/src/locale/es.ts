export default {
  ...
  enterJoinDest: 'Ingrese una URL de sesión de Honeystream.',
  findSession: 'Encontrar sesión',
  findSessionDescription:
    'Únete al <1>#sessions</1> canal Discord de la comunidad Honeystream para encontrar sesiones de otros usuarios. Presione el logotipo de Discord a continuación para unirte.',
  ...
  networkDisconnectMultiTab:
    'Está alojando una sesión Honeystream desde más de un navegador o pestaña. Cierre las otras sesiones, y cargue nuevamente la página.',
