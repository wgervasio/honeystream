export default {
  ...
  enterJoinDest: 'Entrez l’URL de la session Honeystream.',
  findSession: 'Trouver une session',
  findSessionDescription:
    'Rejoignez le canal <1>#sessions</1> de la communauté Honeystream Discord pour rechercher les sessions de d’autres utilisateurs. Cliquez sur le logo Discord ci-dessous pour y rejoindre. ',
  friendCode: 'Code ami',
