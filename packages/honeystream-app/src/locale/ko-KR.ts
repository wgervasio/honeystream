export default {
  ...
  enterJoinDest: 'Honeystream 세션 URL을 입력하세요.',
  findSession: '세션 찾기',
  findSessionDescription:
    'Honeystream Discord 커뮤니티에서 <1>#sessions</1> 채널에 참여하여 다른 유저의 세션을 찾으세요. 아래의 Discord 로고를 클릭하여 참여합니다.',
  friendCode: '친구 코드',
  getStarted: '시작하기',
  info: '정보',
  help: '도움말',
  ...
  networkDisconnectMultiTab:
    '둘 이상의 브라우저에서 Honeystream 세션을 호스팅 하는 경우, 다른 탭이나 브라우저를 닫은 후 페이지를 새로고침 하세요.',
