export default {
  ...
  enterJoinDest: 'Honeystream Sitzungs-URL eingeben.',
  embedBlocked:
    'Um die Wiedergabe mit <1>{{host}}</1> zu starten, muss Honeystream die Webseite in einem Popup öffnen.',
  findSession: 'Sitzung finden',
  findSessionDescription:
    'Trete den <1>#sessions</1> Channel auf dem Honeystream Discord bei, um die Sitzungen anderer Nutzer zu finden. Klicke auf das Discord Logo, um dem Server beizutreten.',
  ...
  networkDisconnectMultiTab:
    'Du hostest eine Honeystream Sitzung über mehr als ein Browser oder Tab. Bitte schließe andere Tabs oder Browser und versuche es erneut.',
  ...
  updateAvailable:
    'Ein Update für Honeystream steht bereit. Drücke den UPDATE Knopf oben rechts um das Update zu erhalten.',
  welcomeToHoneystream: 'Willkommen zu Honeystream'
}
