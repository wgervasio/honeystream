export default {
  ...
  embedBlocked:
    'Чтобы включить воспроизведение с <1>{{host}}</1>, Honeystream откроет веб-сайт во всплывающем окне.',
  ...
  enterJoinDest: 'Введите URL-адрес сеанса Honeystream',
  findSession: 'Найти сеанс',
  findSessionDescription:
    'Присоединяйся к каналу <1>#sessions</1> в Discord сообществе Honeystream для поиска сеансов других пользователей. Нажмите на логотип Discord ниже, чтобы присоединиться.',
  ...
  networkDisconnectMultiTab:
    'Вы запустили сеанс Honeystream более чем с одного браузера или же вкладки. Пожалуйста, закройте все лишние вкладки или браузеры и перезагрузите страницу.',
  ...
  updateAvailable:
    'Доступно обновление для Honeystream. Нажмите кнопку «Обновить» в правом верхнем углу, чтобы загрузить обновление.',
  ...
  welcomeToHoneystream: 'Добро пожаловать на Honeystream'
}
