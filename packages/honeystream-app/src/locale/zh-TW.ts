export default {
  ...
  dj: 'DJ',
  duplicate: '重復',
  embedBlocked: '要開始 <1>{{host}}</1> 的播放, Honeystream 需要在彈出視窗開啟網頁。',
  endSessionTitle: '結束派對嗎?',
  endSessionDescription: '變為離線派對時會切斷所有目前用戶的連接。',
  endSessionModalDescription: '所有用戶將與此會話切斷連接.',
  endSessionButton: '結束',
  enterJoinDest: '輸入一個 Honeystream 派對鏈接.',
  findSession: '查找派對',
  findSessionDescription:
    '加入在 Honeystream Discord 上的 <1>#sessions</1> 頻道來尋找其他用戶的派對. 點擊 Discord 的 LOGO 加入.',
  focusPopup: '專注模式',
  friendCode: '夥伴代碼',
  getStarted: '開始',
  help: '幫助',
  ...
  unlimited: '無限制',
  unlockQueue: '解鎖隊列',
  updateAvailable: 'Honeystream 有更新可用。按右上方 “更新” 鈕以取得更新。',
  username: '用戶名',
  users: '用戶',
  ...
  welcome: '歡迎',
  welcomeToHoneystream: '歡迎來到 Honeystream',
