export default {
  ...
  enterJoinDest: 'Insira um link de uma sessão do Honeystream',
  findSession: 'Encontrar sessões',
  findSessionDescription:
    'Entre no canal <1>#sessions</1> do servidor do Honeystream no Discord para encontrar sessões de outro usuários. Clique na logo do discord abaixo para entrar.',
  ...
  networkDisconnectMultiTab:
    'Você está hospedando uma sessão do Honeystream em mais de um navegador ou aba. Por favor feche as outras abas ou outros navegadores, e recarregue a página.',
  ...
  updateAvailable:
    'Uma atualização do Honeystream está disponivel. aperta o botão de ATUALIZAR no canto superior esquerdo para receber a atualização.',
  ...
  welcome: 'Bem Vindo(a)',
  welcomeToHoneystream: 'Bem vindo(a) ao Honeystream'
}
