export default {
  ...
  enterJoinDest: 'Inserisci un URL sessione Honeystream.',
  findSession: 'Trova Sessione',
  findSessionDescription:
    'Unisciti al canale <1>#sessions</1> nella community Discord di Honeystream per trovare sessioni di altri utenti. Fai clic sul logo Discord in basso per unirti.',
  ...
  networkDisconnectMultiTab:
    'Stai ospitando una sessione Honeystream da più di un browser o scheda. Chiudi le altre schede o gli altri browser, quindi ricarica la pagina.',
