export default {
  ...
  enterJoinDest: 'Bir Honeystream oturum linki giriniz.',
  findSession: 'Oturumu bul',
  findSessionDescription:
    'Honeystream Discord Topluluğunda olan <1>#sessions</1> kanalına katılarak diğer kullanıcıların paylaşmış olduğu oturumlara erişebilirsiniz. Katılmak için Discord logosuna tıklayınız.',
  ...
  networkDisconnectMultiTab:
    'Birden fazla tarayıcı ya da sekmede Honeystream oturumu yönetmektesiniz. Lütfen diğer sekmeleri ya da tarayıcıları kapatınız ve daha sonrasında bulunduğunuz sayfayı yenileyiniz.',
  ...
  welcomeToHoneystream: "Honeystream'e hoş geldiniz"
}
