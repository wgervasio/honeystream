...
function onMessage(event: MessageEvent) {
  ...
  switch (data.type) {
    case 'honeystream-extension-request':
...
async function main() {
  ...
  document.addEventListener('honeystreamRemoteInstalled', extensionInstalled)

  // fix: sometimes the extension installs too late and the app misses its check
  // this can be removed after Honeystream Remote v0.4.2 is released
