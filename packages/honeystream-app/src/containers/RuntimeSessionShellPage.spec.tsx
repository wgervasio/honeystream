...
describe('RuntimeSessionShellPage', () => {
  it('renders route-owned runtime session shell details for the lobby route', () => {
    ...
    expect(html).toContain('0 video bytes')
    ...
    expect(html).toContain('id="runtime_room_pulse"')
    expect(html).toContain('Room pulse')
    expect(html).toContain('Private pair')
    expect(html).toContain('Media stays local')
