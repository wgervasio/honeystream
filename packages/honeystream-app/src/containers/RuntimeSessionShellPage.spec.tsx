...
describe('RuntimeSessionShellPage', () => {
  ...
  it('renders route-owned runtime session shell details for the lobby route', () => {
    ...
    expect(html).toContain('id="runtime_buddy_passport"')
    expect(html).toContain('data-browser-sync-receipt-state="warming"')
    expect(html).toContain('data-live-control-receipt-state="warming"')
    expect(html).toContain('data-passport-live-receipt="warming"')
    expect(html).toContain('data-passport-seal="warming"')
    expect(html).toContain('waiting for the live receipt glow')
