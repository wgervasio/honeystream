...
describe('session', () => {
  ...
  describe('host', () => {
    it('should start a session', async () => {
      ...
      await page.waitForSelector('#runtime_room_pulse')
      ...
      await waitForRuntimeText(page, 'Zero media bytes shared')
      await waitForRuntimeText(page, 'Best next tap')
      await waitForRuntimeText(page, 'Room pulse')
      await waitForRuntimeText(page, 'Media stays local')
      await waitForRuntimeText(page, '0 video bytes shared')
