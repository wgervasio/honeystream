...
describe('session', () => {
  ...
  describe('host', () => {
    it('should start a session', async () => {
      ...
      await waitForRuntimeText(page, '16 local fixtures')
      ...
      await waitForRuntimeText(page, 'Clean fast lane wins')
      await waitForRuntimeText(page, 'Retry lane stays green')
      await waitForRuntimeText(page, 'Site matrix covered')
      await waitForRuntimeText(page, '5 lanes run for 3 deterministic trials')
