...
describe('onboarding', () => {
  ...
  it('should show home on next visit', async () => {
    ...
    await page.waitForSelector('#home_connection_lab')
    ...
    const connectionLab = await page.$eval('#home_connection_lab', e => e.textContent)
    ...
    expect(siteExamples).toContain('Vimeo')
    expect(siteExamples).toContain('Twitch')
    expect(siteExamples).toContain('Netflix-style pages')
    expect(siteExamples).toContain('Hulu')
    expect(siteExamples).toContain('Prime Video')
    ...
    expect(siteExamples).toContain('SoundCloud')
    expect(siteExamples).toContain('Facebook Watch')
