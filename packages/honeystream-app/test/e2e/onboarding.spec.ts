...
describe('onboarding', () => {
  ...
  it('should show home on next visit', async () => {
    ...
    await page.waitForSelector('#home_pair_handoff')
    ...
    const pairHandoff = await page.$eval('#home_pair_handoff', e => e.textContent)
    ...
    expect(pairHandoff).toContain('Chooses the source')
    expect(pairHandoff).toContain('Lands from invite')
    expect(pairHandoff).toContain('Watches in sync')
